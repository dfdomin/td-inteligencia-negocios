...
## Evaluacion: Estrategia Integral de Transformacion Digital
**Caso espejo:** LogisCaribe Operador Logistico S.A.S.
**Ponderacion:** 30% de la nota final del modulo
...
Esta evaluacion es acumulativa: integra todo el aprendizaje del modulo.
...
```
casos/logiscaribe/DOSSIER.md
```

Contiene:
- Carta de solicitud del gerente general.
- Descripcion completa de servicios, flota y clientes.
- Proceso actual completo (receccion, rutas, entrega, facturacion, devoluciones).
- Datos operativos 2025 (1.840 entregas/mes, 14% tasa de falla, 3.4/5.0 satisfaccion).
- Caso de incidente critico (carga extraviada, octubre 2025).
- Testimonios de clientes.
- Restricciones: presupuesto $40M/12 meses, 15 horas/semana de equipo directivo.
- Marco normativo: Decreto 1079, Ley 1581, regulacion Dian.
...
1. Leer el dossier de LogisCaribe al menos dos veces.
2. Revisar portafolio construido durante el semestre (evidencias de Mercado360).
3. Consultar notas de todas las semanas (1-13) para integrar conceptos.
4. Preparar sustentacion de 10 minutos.

### 3.2 Durante la evaluacion
- Duracion: 120 minutos (escrita).
- Modalidad: Escrita con apoyo del dossier y notas propias.
- Sustentacion: En la misma sesion o en sesion posterior segun programacion.
- No se permite internet.

### 3.3 Producto esperado

Un documento de maximo 15 paginas (sin contar anexos) que incluya:
...
- Nivel de madurez actual de LogisCaribe en un modelo reconocido.
- 3-5 dimensiones evaluadas con evidencia del dossier.
- Justificacion de nivel.

**Seccion 3 — Analisis de puntos criticos (1.5 paginas)**
- Trazabilidad.
- Visibilidad de operacion.
- Gestion de devoluciones.
- Servicio al cliente.
- Para cada area: descripcion del problema, evidencia del dossier, impacto.

**Seccion 4 — Estrategia priorizada (2 paginas)**
- Objetivo estrategico general.
- 3 iniciativas clave priorizadas.
- Justificacion de priorizacion (impacto vs. factibilidad).
- Conexion con las restricciones del caso.

**Seccion 5 — Hoja de ruta 30-60-90 dias (2.5 paginas)**
- Fase 1 (30 dias): victorias rapidas sin inversion alta.
  - Acciones, responsable, entregable, costo estimado, metricas.
- Fase 2 (60 dias): soluciones iniciales con inversion moderada.
  - Acciones, responsable, entregable, costo estimado, metricas.
...
**Seccion 7 — Matriz de riesgos digitales (1.5 paginas)**
- 6 riesgos minimo.
- Para cada riesgo: descripcion, probabilidad, impacto, estrategia de mitigacion, responsable.
...
- Presentacion ejecutiva ante la gerencia de LogisCaribe.
- Los puntos clave que debe cubrir:
  1. Donde esta LogisCaribe hoy (diagnostico).
  2. Por donde empezamos (oportunidad prioritaria).
  3. Que vamos a hacer en 30-60-90 dias.
  4. Como medimos que funciona (KPIs).
  5. Cuanto cuesta y cuanto genera.
...
|---|---|---:|
| Seccion 1 — Resumen ejecutivo | 5 min | 5 |
...
| Seccion 9 — Caso de negocio | 10 min | 10 |
| Sustentacion | 10 min | (incluida en global) |
| Revision | 5 min | - |
| **Total** | **120 min** | **100 pts** |
...
| RA | Criterio de evaluacion | Ponderacion |
|---|---|---:|
...
**Modelo esperado:**
Breve, ejecutivo, maximo 1 pagina. Debe responder: donde estamos, a donde vamos, como lo haremos, cuanto cuesta, como medimos exito.
...
- Sin sistema de informacion.
- Decisiones por intuicion.
...
1. **Trazabilidad de entregas** (mas urgente por contrato Distribuidora del Caribe).
   ...
   - App de tracking para cliente.
   - Firma digital de entrega.

2. **Centralizar operaciones** (visibilidad).
   - Reemplazar Excel con sistema unificado de gestion de pedidos.
   - Dashboard de operaciones.

3. **Automatizar comunicacion con cliente** (servicio).
   - Notificaciones automaticas.
   - Portal de seguimiento para clientes corporativos.

**Descartes esperados:**
- ERP completo desde el inicio (costo y complejidad muy altos).
- Desarrollo de app nativa propia (sin equipo TI).
- Cambio de flota completo (no hay presupuesto).
...
- WhatsApp Business API para notificaciones automaticas.
- Firmar de entrega con fotografia por WhatsApp.

**Fase 2 (60 dias, $10-15M):**
- Plataforma de tracking para clientes (AirTable o web basica).
- Dashboard de operaciones para coordinacion.
- Capacitacion a conductores y coordinacion.
...
**Formato:** Presentacion de maximo 10 minutos ante la "gerencia" (docente y compañeros simulando gerencia de LogisCaribe).

**Puntos obligatorios:**
1. Diagnostico en 1 minuto.
2. Hoja de ruta en 3 minutos.
3. KPIs y beneficios en 2 minutos.
4. Costos e inversion en 1 minuto.
...
## 9. Materiales que puede usar el estudiante
...
- **Semana de aplicacion:** Semana 14 del calendario.
- **Duracion total:** 120 minutos escrita + sustentacion de 10 minutos por equipo.
- **Modalidad de entrega:** Individual, documento escrito + sustentacion.
- **Ponderacion en la nota final del modulo:** 30%.
- **Acumulacion:** Esta evaluacion integra RA1, RA2 y RA3 del modulo.
- **Ganancia pedagogica:** La tarea de semana 13 consiste en preparar un borrador del caso de negocio ligero sobre Mercado360. Ese ejercicio sirve como preparacion directa para esta evaluacion.
