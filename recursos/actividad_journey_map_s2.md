...
**Duración estimada:** 50-60 minutos (trabajo grupal)  
**Materiales:** Este documento, cartulina o papelote (tamaño mínimo A3), marcadores de colores, post-its, cinta de enmascarar
...
## El contexto de Mercado360

Mercado360 opera en Corferias, Bogotá, los miércoles, viernes, sábado y domingo, de 4:00 AM a 2:00 PM. El mercado tiene 87 puestos, 23 de frutas y verduras. El flujo promedio es de 600 compradores en día pico.
...
- 1 cartulina grande o papelote (mínimo 60cm x 90cm)
- Marcadores de colores (rojo, azul, verde, negro, amarillo)
- Post-its de al menos 2 colores diferentes
- Cinta de enmascarar (para pegar post-its)
- Lápices y borrador
- Copia de este documento de instrucciones

---

## Instrucciones paso a paso

### Paso 1 — Definir el perfil del cliente (5 minutos)

Elijan uno de los dos perfiles de cliente para mapear:

**Opción A — Cliente ocasional (consumidor final):**
- Nombre: Doña María
- Edad: 45 años
- Ocupación: Contadora, trabaja en oficina
- Motivación: Comprar frutas y verduras frescas para su familia durante el fin de semana
- Comportamiento: Busca calidad, precio justo y conveniencia. No tiene mucho tiempo. Usa WhatsApp para comunicarse pero no compras en línea habitualmente.
- Dolor actual: Le cuesta encontrar lo que busca, no sabe qué hay disponible antes de ir, pierde tiempo comparando precios.

**Opción B — Cliente institucional (restaurante/empresa):**
...
```
[PERFIL: Doña María, 45 años, consumidora final]

SUPERIOR:    [Motivaciones / Qué piensa]
...
### Paso 3 — Mapear motivaciones y pensamientos (10 minutos)

En la fila superior (sobre cada etapa), escriban o peguen post-its con:

- **Qué piensa** el cliente en esta etapa
- **Qué motivación** lo impulsa
...
- Etapa 1 (Descubrimiento): Piensa "¿Hay forma de saber qué hay disponible esta semana sin tener que ir físicamente?", motivación: planificar el menú con anticipación, necesita un canal de información anticipada.
- Etapa 4 (Selección): Piensa "Necesito 50 kilos de tomate de calidad consistente, no importa el proveedor", motivación: garantir calidad y volumen, necesita poder comparar ofertas de múltiples puestos en un solo lugar.

---

### Paso 4 — Mapear emociones (5 minutos)
...
## Ejemplo visual simplificado (para referencia del docente)
...
╠══════════════════════════════════════════════════════════════════╣
║                                                                  ║
║  MOTIVACIÓN    ┃Descubrimiento┃  Llegada   ┃ Exploración┃        ║
║  Y PENSAMIENTO ┃ "Voy a ir al ┃"Está lleno┃"Espero     ┃        ║
║                ┃  mercado"    ┃"Dónde      ┃ encontrar  ┃        ║
║                ┃              ┃ estaciono?"│ mango"    ┃        ║
║  ──────────────┸──────────────┸────────────┸────────────┸        ║
║  ETAPA         ┃    1        ┃     2      ┃     3      │        ║
║  ──────────────┸──────────────┸────────────┸────────────┸        ║
...
╠══════════════════════════════════════════════════════════════════╣
║ OPORTUNIDAD: Catálogo digital accesible desde celular            ║
║              que muestre productos por puesto con precios         ║
╚══════════════════════════════════════════════════════════════════╝
```

---

## Plantilla en blanco para los estudiantes

```
╔══════════════════════════════════════════════════════════════════╗
║ PERFIL: _____________________________________________________  ║
╠══════════════════════════════════════════════════════════════════╣
║                                                                  ║
║  MOTIVACIÓN    ┃            ┃           ┃             ┃        ║
║  Y PENSAMIENTO ┃            ┃           ┃             ┃        ║
