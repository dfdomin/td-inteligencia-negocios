# Dossier del caso — LogisCaribe Operador Logistico S.A.S.
## Evaluacion Final, Semana 14 — Transformacion Digital en la Empresa

---

## 1. Carta de solicitud inicial

**De:** Carlos Eduardo Martinez Puello, Gerente General — LogisCaribe Operador Logistico S.A.S.
**Para:** [Asesor de estrategia de transformacion digital]
**Fecha:** 3 de febrero de 2026
**Asunto:** Solicitud de formulacion de hoja de ruta digital para LogisCaribe
...
**Cobertura:** Region Caribe (Atlantico, Magdalena, Cesar, Sucre). Operaciones excepcionales en Bogota y Medellin por alianzas.

**Flota:** 12 vehiculos propios (8 vans, 4 camiones pequeno porte). 8 conductores asalariados, 4 vehiculos rentados con conductor.

**Clientes principales:**
- Distribuidora del Caribe S.A.S. (40% ingresos) — supermercados y tiendas de barrio
- FarmaNorte S.A.S. (25% ingresos) — farmacia y perfumeria
- HogarExpress S.A.S. (20% ingresos) — electrodomesticos menores
- Varios clientes menores (15% ingresos)

**Equipo humano:** 22 personas (gerencia 3, operaciones 8, conductores 8, administrativa 3).
...
| Indicador | Valor 2025 | Nota |
|---|---|---|
| Entregas mensuales promedio | 1.840 | Crecimiento 12% vs 2024 |
| Numero de clientes activos | 45 | Corporativos y menores |
| Tasa de falla en primera entrega | 14% | Sin medicion sistematica hasta 2025 |
| Tiempo promedio de entrega | 3.2 dias | Desde recepcion hasta entrega |
...
## 5. Testimonios de clientes corporativos

### Testimonio 1 — Distribuidora del Caribe (cliente clave, 40% ingresos)

**Correo electronico de amenaza de cancelacion:**
...
Saludos,
Jorge Luis Ramirez T.
Director Logistica — Distribuidora del Caribe S.A.S.

---

### Testimonio 2 — Farmanorte

"Llevamos dos años con LogisCaribe y el servicio es acceptable, pero cuando hay un problema demoran mucho en responder. Tuve que esperar hasta ocho horas para saber de una carga que se extravio. No es aceptable para nosotros."

---

### Testimonio 3 — Conductores

**Vendedor (WhatsApp group):**
...
## 6. Caso de incidente critico

**Incidente: Carga extraviada por falta de trazabilidad**

**Fecha:** 15 de octubre de 2025
**Cliente:** HogarExpress S.A.S.
**Descripcion:** HogarExpress recibio un pedido de 12 unidades de microondas para entregas a tiendas de barrio en el norte de Barranquilla. LogisCaribe recibio la carga en bodega el 12 de octubre. Dos unidades no aparecieron al momento de la entrega.
...
## 8. Marco normativo relevante

**Decreto 1079 de 2015 (Decreto Unico Reglamentario del Sector Transporte):**
- Los operadores logisticos de carga terrestre deben cumplir condiciones de habilitacion.
- Registro Nacional de Carga (RNCTD).
- Responsabilidad del operador sobre la mercancia en todo momento.
...
## 9. Resultado esperado para el estudiante

El estudiante debe actuar como estratega de transformacion digital y entregar un documento completo que incluya:

1. **Resumen ejecutivo** (1 pagina).

2. **Diagnostico de madurez digital** de LogisCaribe (modelo de referencia).

3. **Analisis de puntos criticos:**
   - Trazabilidad
   - Visibilidad de operacion
   - Gestion de devoluciones
   - Servicio al cliente

4. **Estrategia priorizada** de transformacion digital con:
   - Objetivo estrategico
   - Iniciativas clave
   - Priorizacion basada en impacto y factibilidad

5. **Hoja de ruta 30-60-90 dias:**
   - Fase 1 (30 dias): victorias rapidas, sin inversion alta.
   - Fase 2 (60 dias): soluciones iniciales.
...
El entregable es un documento de maximo 15 paginas + anexos.
