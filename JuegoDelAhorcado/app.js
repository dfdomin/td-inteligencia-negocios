const STORAGE_STUDENTS = "td_students_v1";
const alphabet = "ABCDEFGHIJKLMNÑOPQRSTUVWXYZ".split("");
const bodyOrder = ["head", "torso", "left-arm", "right-arm", "left-leg", "right-leg"];

const WORD_BANK = {
  "Mercado360": [
    "MERCADO360", "TRANSFORMACION", "DIGITAL", "INVENTARIO", "WHATSAPP",
    "ECOMMERCE", "OMNICANAL", "DATOS", "KPI", "ROADMAP", "QUICK WIN",
    "RETAIL", "LOGISTICA", "INNOVACION", "STARTUP",
  ],
  "Transformacion Digital": [
    "ESTRATEGIA", "CULTURA", "PROCESO", "AUTOMATIZACION", "DISRUPCION",
    "MADUREZ", "ADOPCION", "CAMBIO", "VALOR", "LIDERAZGO", "AGILIDAD",
    "EXPERIENCIA", "CLIENTE", "MODELO", "CAPACIDAD",
  ],
  "Tecnologia": [
    "CLOUD", "API", "IOT", "BIG DATA", "ANALITICA", "CRM", "ERP",
    "SAAS", "PLATAFORMA", "INTEGRACION", "SISTEMA", "RED", "SEGURIDAD",
  ],
  "Negocios": [
    "CLIENTE", "VENTAS", "MERCADO", "PRODUCTO", "SERVICIO", "ROI",
    "EXPERIENCIA", "CADENA", "OPERACION", "COMPETENCIA", "EQUIPO",
    "PROYECTO", "INDICADOR", "RESULTADO", "VIABILIDAD",
  ],
};
...
function supabaseCredentials() {
  ...
  return {
    url: window.SUPABASE_URL || localStorage.getItem("td_supabase_url"),
    key: window.SUPABASE_KEY || localStorage.getItem("td_supabase_key"),
  };
}
...
async function fetchStudentsFromSupabase() {
  ...
  const offering = encodeURIComponent(
    (typeof GamifSDK !== "undefined" && GamifSDK.getOfferingCode()) || "TD-2026-2"
  );
  try {
    let res = await fetch(
